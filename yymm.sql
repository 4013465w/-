...
(1, '2015/05/16/661873666.png', '240_282', '2015-05-16'),
...
(5, '2015/05/16/911483681.json', 'ff', '2015-05-16'),
(6, '2015/05/22/104029564.jpg', '153323w76bxc6bf5jx1177', '2015-05-22'),
(7, '2015/05/22/673673707.jpg', '153324odpvfrgvd5xww5dn', '2015-05-22'),
(8, '2015/05/22/232628833.jpg', '153325tm22l8z8m2hdzkcy', '2015-05-22'),
(9, '2015/05/22/503315082.jpg', '155524jbv6l8i8giq547j8', '2015-05-22'),
(10, '2015/05/22/443394115.jpg', '165453iyzhpznt86ymm8nv', '2015-05-22'),
(11, '2015/05/22/1181332498.jpg', '200959pjnm2jjg92o7n7j9', '2015-05-22'),
(12, '2015/05/22/163771024.jpg', '224314fdb0nxyuww0bvt5h', '2015-05-22'),
(13, '2015/05/22/1116376943.jpg', 'QQ图片20140905172105', '2015-05-22'),
(14, '2015/05/22/468475604.jpg', 'QQ图片20141108110017', '2015-05-22');

-- --------------------------------------------------------

--
-- 表的结构 `yymm_commentmeta`
--

CREATE TABLE IF NOT EXISTS `yymm_commentmeta` (
...
CREATE TABLE IF NOT EXISTS `yymm_comments` (
...
--
-- 转存表中的数据 `yymm_comments`
--

INSERT INTO `yymm_comments` (`comment_ID`, `comment_post_ID`, `comment_author`, `comment_author_email`, `comment_author_url`, `comment_author_IP`, `comment_date`, `comment_date_gmt`, `comment_content`, `comment_karma`, `comment_approved`, `comment_agent`, `comment_type`, `comment_parent`, `user_id`) VALUES
(1, 1, 'WordPress先生', '', 'https://wordpress.org/', '', '2015-05-16 13:22:05', '2015-05-16 05:22:05', '您好，这是一条评论。\n要删除评论，请先登录，然后再查看这篇文章的评论。登录后您可以看到编辑或者删除评论的选项。', 0, '1', '', '', 0, 0);
...
CREATE TABLE IF NOT EXISTS `yymm_links` (
...
CREATE TABLE IF NOT EXISTS `yymm_options` (
...
--
-- 转存表中的数据 `yymm_options`
--

INSERT INTO `yymm_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
(1, 'siteurl', 'http://localhost/yd/ytu', 'yes'),
(2, 'home', 'http://localhost/yd/ytu', 'yes'),
(3, 'blogname', '烟雨蒙蒙', 'yes'),
...
CREATE TABLE IF NOT EXISTS `yymm_postmeta` (
  `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `yymm_postmeta`
--

INSERT INTO `yymm_postmeta` (`meta_id`, `post_id`, `meta_key`, `meta_value`) VALUES
...
CREATE TABLE IF NOT EXISTS `yymm_posts` (
...
INSERT INTO `yymm_posts` (`ID`, `post_author`, `post_date`, `post_date_gmt`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `ping_status`, `post_password`, `post_name`, `to_ping`, `pinged`, `post_modified`, `post_modified_gmt`, `post_content_filtered`, `post_parent`, `guid`, `menu_order`, `post_type`, `post_mime_type`, `comment_count`) VALUES
(1, 1, '2015-05-16 13:22:05', '2015-05-16 05:22:05', '欢迎使用WordPress。这是系统自动生成的演示文章。编辑或者删除它，然后开始您的博客！', '世界，你好！', '', 'publish', 'open', 'open', '', 'hello-world', '', '', '2015-05-16 13:22:05', '2015-05-16 05:22:05', '', 0, 'http://localhost/yd/ytu/?p=1', 0, 'post', '', 1),
(2, 1, '2015-05-16 13:22:05', '2015-05-16 05:22:05', '这是示范页面。页面和博客文章不同，它的位置是固定的，通常会在站点导航栏显示。很多用户都创建一个“关于”页面，向访客介绍自己。例如，个人博客通常有类似这样的介绍：\n\n<blockquote>欢迎！我白天是个邮递员，晚上就是个有抱负的演员。这是我的博客。我住在天朝的帝都，有条叫做杰克的狗。</blockquote>\n\n……公司博客可以这样写：\n\n<blockquote>XYZ Doohickey公司成立于1971年，自从建立以来，我们一直向社会贡献着优秀doohicky。我们的公司总部位于天朝魔都，有着超过两千名员工，对魔都政府税收有着巨大贡献。</blockquote>\n\n您可以访问<a href="http://localhost/yd/ytu/wp-admin/">仪表盘</a>，删除本页面，然后添加您自己的内容。祝您使用愉快！', '示例页面', '', 'publish', 'open', 'open', '', 'sample-page', '', '', '2015-05-16 13:22:05', '2015-05-16 05:22:05', '', 0, 'http://localhost/yd/ytu/?page_id=2', 0, 'page', '', 0),
(3, 1, '2015-05-16 13:22:21', '0000-00-00 00:00:00', '', '自动草稿', '', 'auto-draft', 'open', 'open', '', '', '', '', '2015-05-16 13:22:21', '0000-00-00 00:00:00', '', 0, 'http://localhost/yd/ytu/?p=3', 0, 'post', '', 0);
...
CREATE TABLE IF NOT EXISTS `yymm_terms` (
...
INSERT INTO `yymm_terms` (`term_id`, `name`, `slug`, `term_group`) VALUES
(1, '未分类', 'uncategorized', 0);

-- --------------------------------------------------------

--
-- 表的结构 `yymm_term_relationships`
--

CREATE TABLE IF NOT EXISTS `yymm_term_relationships` (
...
--
-- 转存表中的数据 `yymm_term_relationships`
--

INSERT INTO `yymm_term_relationships` (`object_id`, `term_taxonomy_id`, `term_order`) VALUES
(1, 1, 0);

-- --------------------------------------------------------

--
-- 表的结构 `yymm_term_taxonomy`
--

CREATE TABLE IF NOT EXISTS `yymm_term_taxonomy` (
...
--
-- 转存表中的数据 `yymm_term_taxonomy`
--

INSERT INTO `yymm_term_taxonomy` (`term_taxonomy_id`, `term_id`, `taxonomy`, `description`, `parent`, `count`) VALUES
(1, 1, 'category', '', 0, 1);
...
CREATE TABLE IF NOT EXISTS `yymm_usermeta` (
...
--
-- 转存表中的数据 `yymm_usermeta`
--

INSERT INTO `yymm_usermeta` (`umeta_id`, `user_id`, `meta_key`, `meta_value`) VALUES
(1, 1, 'nickname', 'autumn'),
(2, 1, 'first_name', ''),
(3, 1, 'last_name', ''),
(4, 1, 'description', ''),
...
(10, 1, 'yymm_capabilities', 'a:1:{s:13:"administrator";b:1;}'),
(11, 1, 'yymm_user_level', '10'),
(12, 1, 'dismissed_wp_pointers', 'wp360_locks,wp390_widgets'),
(13, 1, 'show_welcome_panel', '1'),
(14, 1, 'session_tokens', 'a:1:{s:64:"95b292d2e6544dc3cff38dc10fc2d3173c1e38d97b98258d2ec8915d846e3f57";a:4:{s:10:"expiration";i:1431926539;s:2:"ip";s:9:"127.0.0.1";s:2:"ua";s:109:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.118 Safari/537.36";s:5:"login";i:1431753739;}}'),
(15, 1, 'yymm_dashboard_quick_press_last_post_id', '3');
...
CREATE TABLE IF NOT EXISTS `yymm_users` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `yymm_users` (`ID`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `user_registered`, `user_activation_key`, `user_status`, `display_name`) VALUES
(1, 'autumn', '$P$B8XqSI3IOniiCkAhatZ3a71FSakeno1', 'autumn', '4013465w@sina.com', '', '2015-05-16 05:22:05', '', 0, 'autumn');
